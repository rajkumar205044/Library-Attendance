...
?>
    ...
    <!-- Add more rows as needed -->
            ...
            <button class="print" id="downloadBtn" name="print"><i class="fa-solid fa-print"></i>print</button></form>
        </article> 
        <form method="post">
        <aside>
            <h1 style="text-align: center;" id="menu">MENU</h1><br>
        <nav class="menu">  
            <button style="width: 100%;" class="current" name="today"><h2><i class="fa-solid fa-calendar-week"></i> Today </h2> </button> 
